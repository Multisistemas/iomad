...
* @paradiso
*/
$string['auth_token_error_login_page_username_warning'] = "Por favor ingrese un nombre de usuario valido"; 
$string['or'] = "-o-";
$string['watermark_username'] = "Nombre de usuario";
$string['watermark_password'] = "Contraseña";
$string['password_warning'] = "Por favor ingrese una contraseña valida";
$string['blk_username'] = "Por favor ingrese su nombre de usuario";
$string['blk_password'] = "Por favor ingrese su contraseña";
