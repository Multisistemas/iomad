...
class core_course_management_renderer extends plugin_renderer_base {
    ...
    public function category_listitem(coursecat $category, array $subcategories, $totalsubcategories,
        ...
        if ($isexpanded) {
            $icon = $this->output->pix_icon('t/switch', get_string('collapse'), 'moodle', array('class' => 'tree-icon', 'title' => ''));
            ...
            $icon = $this->output->pix_icon('t/switch', get_string('expand'), 'moodle', array('class' => 'tree-icon', 'title' => ''));
            $icon = html_writer::link(
                $viewcaturl,
                $icon,
                array(
